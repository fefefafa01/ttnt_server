...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert("ms_displacement", data, {});
    },

    async down(queryInterface, Sequelize) {
        return queryInterface.bulkDelete("ms_displacement", {});
    },
};
