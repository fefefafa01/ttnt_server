...
router
    ...
    .post(async (req, res) => {
        if (typeof(req.body)!=="object") {
            ...
            //     role = "Admin"
            // }
            if (qrole.rows[0]!==undefined && qfirstname.rows[0]!==undefined && qlastname.rows[0]!==undefined) {
                ...
                logger.dlogger.log("error", "Null Profile Data")
            }
        } else {
            logger.dlogger.log("error", "Null Profile Input Request")
        }
    })
